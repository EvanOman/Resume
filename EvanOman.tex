...
\begin{document}
	...
	\resHeading{Experience}
		...
		\threeColSubHeading{Black River Systems Co.}{Engineer}{May 2015 - Present}
			\begin{itemize}
				...
				\myitem Perform domain background research, rapidly develop proof-of-concept prototypes, and build software using \verb!Java!, \verb!Matlab! 
			\end{itemize}
		% Salt IO
	...
	\resHeading{Skills}
		\textbf{Languages:}
		Have worked in \verb!Java!, \verb!Scala!(top 5\% on Stack Overflow), \verb!C!, \verb!R!, \verb!Perl!, \verb!Python!, \LaTeX; Apache Spark(top 5\% on Stack Overflow); Some knowledge of \verb!C++!, \verb!MATLAB!, \verb!Kotlin!

		\textbf{Applications/Tools:}
		Gradle, JUnit, IntelliJ, \verb!git!(Github: \href{https://www.github.com/EvanOman}{EvanOman})), Apache Spark, Windows + Linux CLI
