...
\begin{document}
	...
	\resHeading{Experience}
		% Black River
		\threeColSubHeading{Black River Systems Co.}{Engineer}{May 2015 - Present}
			\begin{itemize}
				...
				\myitem Interface directly with customers and direct engineering efforts, authored a successful contract proposal (\$1M over 2 years)
	...
	\resHeading{Projects}
		...
		\twoColSubHeading{Low SWAP RF Analysis System}{Black River Systems}
			\begin{itemize}
				\myitem Leading the R\&D  of an edge computing system which applies deep learning techniques to radio freq. emission classification
