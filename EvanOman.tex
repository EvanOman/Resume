...
\begin{document}
	...
	\resheading{Experience}
		...
		\rressubheading{Salt IO}{Data Science Consultant}{November 2015 - Present}
			\vspace{-.1in}
			\begin{itemize}
				\resitem{Part Time Position. Assisted with a variety of data preparation and cleaning tasks on mortgage securitization data using Apache Spark (Scala API)}
				\resitem{Researched and implemented NLP techniques for information extraction and conversational agent problems (Spark, Scala, CoreNLP, Python)}
			\end{itemize}
			\vspace{.1in}
		% OSI 
