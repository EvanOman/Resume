...
\begin{document}
	...
	\resHeading{Experience}
		...
		\threeColSubHeading{Black River Systems Co.}{Engineer}{May 2015 - Present}
			\begin{itemize}
				...
				\myitem Survey current domain research, rapidly develop proof-of-concept prototypes, and develop software with \verb!Java!, \verb!Matlab!, \verb!C++! 
	...
	\resHeading{Projects}
		% OPIR 
		\twoColSubHeading{Intelligent Cuing for OPIR Assets}{Black River Systems}
			\begin{itemize}
				\myitem Helped develop an intelligent cuing system for managing OPIR assets within a multi-objective threat management framework
				\myitem Researched and prototyped optimization algorithms, developed full simulation environment, and demonstrated performance
			\end{itemize}
		% Aspect Extraction
